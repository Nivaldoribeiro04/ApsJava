...
public class ChatSuporte extends JFrame {
	...
	public ChatSuporte() {
		...
		JLabel nomeUser = new JLabel("USUARIO");
		nomeUser.setBackground(Color.WHITE);
		nomeUser.setFont(new Font("Sitka Text", Font.BOLD, 14));
		nomeUser.setLabelFor(this);
		nomeUser.setToolTipText("");
		nomeUser.setBounds(10, 11, 436, 21);
